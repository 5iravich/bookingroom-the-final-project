<?php 
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
		...
		try {
			// Update profile
			$update_team_data = $conn->prepare("UPDATE teams SET gender = :gender, firstname = :firstname, lastname = :lastname, position = :position, grouptech = :grouptech, 
											    tel = :tel, password = :password WHERE team_id = :team_id");
	...
	<body>
		...
		<div class="container-profile">
			<form action="" method="POST">
				<div class="back-page">
					<a href="technician.php" class="btn btn-secondary"><i class='bx bx-arrow-back' ></i> ย้อนกลับ</a>
				</div>
				...
				<div class="column">
                    <label for="team_id">รหัสประจำตัวนิสิต: </label>
					...
					<input type="text" id="grouptech" name="grouptech" value="<?php echo $team['grouptech']; ?>"><br>
				</div>
